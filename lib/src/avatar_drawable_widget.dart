...
class AvatarDrawable extends StatefulWidget {
  ...
  @override
  _AvatarDrawableState createState() => _AvatarDrawableState();
}

class _AvatarDrawableState extends State<AvatarDrawable> {
